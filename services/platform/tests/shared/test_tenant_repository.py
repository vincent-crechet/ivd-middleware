"""Shared tests for TenantRepository - runs with both in-memory and PostgreSQL adapters.

These tests verify that both adapter implementations satisfy the ITenantRepository interface.
Each test automatically runs twice: once with in-memory adapter, once with PostgreSQL adapter.
"""
...
class TestTenantRepository:
    """Shared tests for Tenant Repository adapters.

    Tests are parametrized to run with both in-memory and PostgreSQL implementations.
    Each test automatically runs twice without code duplication.
    """
