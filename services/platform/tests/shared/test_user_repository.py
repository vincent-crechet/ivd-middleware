"""Shared tests for UserRepository - runs with both in-memory and PostgreSQL adapters.

These tests verify that both adapter implementations satisfy the IUserRepository interface.
...
class TestUserRepository:
    """Shared tests for User Repository adapters.
